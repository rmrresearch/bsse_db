...
The `pymol_xyz/` directory contains 268 `.xyz` files for the
translational configurations, named using the original
`FF_distance_x_y_z.xyz` convention. The `load_dimers.pml` script
loads all 268 configurations into PyMOL for visualization.
